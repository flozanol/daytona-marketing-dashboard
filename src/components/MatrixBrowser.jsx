...
import { Search, Filter, ChevronRight, FileSpreadsheet, Calendar, Building2, PlusCircle } from 'lucide-react'
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <button
                        onClick={() => onViewDetail(null)}
                        className="btn bg-primary/10 border border-primary/20 text-primary px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-primary/20 transition-colors"
                    >
                        <PlusCircle size={16} />
                        Nueva Carga
                    </button>
